...
namespace Dapper
{
    ...
    public struct CommandDefinition
    {
        ...
        internal IDbCommand SetupCommand(IDbConnection cnn, Action<IDbCommand, object> paramReader)
        {
            ...
            if (Transaction != null)
            {
                SetCmdTransaction(cmd, Transaction);
            }
        ...
        private void SetCmdTransaction(IDbCommand cmd, IDbTransaction transaction)
        {
            if (transaction.GetType().Equals(typeof(TransactionImplement)))
            {
                cmd.Transaction = (transaction as TransactionImplement).Transaction;
            }
            else
            {
