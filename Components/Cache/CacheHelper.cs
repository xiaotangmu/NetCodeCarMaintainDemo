...
namespace Cache
{
    ...
    public class CacheHelper
    {
        ...
        {
            _cache.Set(strKey,objCache,timeOut);
        }
        ...
        {
            _cache.Set(strKey, objCache, absoluteExpiration);
        ...
        public static void SetCache(string CacheKey, object objObject, DateTime absoluteExpiration, TimeSpan slidingExpiration)
        {
            ...
            _cache.Set(CacheKey, objObject, new MemoryCacheEntryOptions()
